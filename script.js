...
var colorKey = { '0.6%': '#e7d0ff', '10.6%': '#8c19ff', '0.4%': '#ebd8ff', '8.7%': '#a64cff', '6.4%': '#bf7fff', '8.5%': '#a64cff', '9.1%': '#9932ff', '0.8%': '#e7d0ff', '1.3%': '#e3c9ff', '2.3%': '#dfc1ff', '2.5%': '#dfc1ff', '0.2%': '#ebd8ff', '0.1%': '#ebd8ff', '0.7%': '#e7d0ff', '1.8%': '#e3c9ff', '2.9%': '#dfc1ff', '5.5%': '#cc99ff', '18.1%': '#8000ff', '3.6%': '#dbb9ff', '6.1%': '#bf7fff', '0.9%': '#e7d0ff', '2.4%': '#dfc1ff', '0.3%': '#ebd8ff' }
var us_state_abbrev = {
    'alabama': 'AL',
    'alaska': 'AK',
    'arizona': 'AZ',
...
function getStateToVoteIn() {
    ...
    if (parseFloat(stateScores.tippingPower)>=parseFloat(NC_Scores.tippingPower) && parseFloat(stateScores.votingPowerIndex)>=parseFloat(NC_Scores.votingPowerIndex)){
